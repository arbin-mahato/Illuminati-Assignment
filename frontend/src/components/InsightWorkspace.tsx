...
export function InsightWorkspace() {
  ...
  return <main className={`app-shell ${isSidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
    <aside className="sidebar">
      <a className="brand" href="#top" aria-label="QuickBite Insight Studio home"><span className="brand-mark">Q</span><span>QuickBite Insight<br /><strong>Studio</strong></span></a>
